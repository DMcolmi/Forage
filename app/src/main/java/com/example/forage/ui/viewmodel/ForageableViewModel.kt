...
class ForageableViewModel(
    ...
    val allForageables: LiveData<List<Forageable>> = forageableDao.getAllForageable().asLiveData()

    fun getForageableItem(id: Long): LiveData<Forageable> = forageableDao.getForageable(id).asLiveData()
